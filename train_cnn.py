...
from imbalance_deep_regression_yield_forecasting.models.UNetConvLSTM import UNet2DConvLSTM
...
if __name__ == "__main__":
    ...
    # Wasserstien Exp Names: EXP_ExpNum_BatchSize_Lr_Wd.PValue_Blur_WeightValue.WorWoutResampling.LossName
    # wds = [0.09, 0.20, 0.70, 0.05]
    # for wd in wds: 
    ExpName = '016_64_001_05_WD_Resample_3.9_huberLoss'
    run(batch_size = 64, dropout = 0.5, 
        learning_rate = 0.001, weight_decay = 0.05,
        epochs = 200, loss_stop_tolerance = 100, 
